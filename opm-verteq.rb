...
class OpmVerteq < Formula
  homepage 'http://www.opm-project.org/'
  url      'https://github.com/OPM/opm-verteq.git', :tag => 'release/2013.10/final'
  head     'https://github.com/OPM/opm-verteq.git', :branch => 'master'
  ...
  depends_on 'opm-core'  => ('--with-c++11' if build.with? 'c++11')
